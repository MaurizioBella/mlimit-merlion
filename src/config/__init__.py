...
MERLION_TRAINING_SAMPLE = os.getenv("MERLION_TRAINING_SAMPLE", 90)
MERLION_PREDICT_MODEL = os.getenv("MERLION_PREDICT_MODEL", 0)
...
# CONFIGURATION MERLION
logging.logger.debug('MERLION_MAX_FORECAST_STEPS %s',
